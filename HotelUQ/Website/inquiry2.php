...
*** Notes **********************************************************************
This file provides functionality to view a list of most popular rooms with their count of reservations. 
********************************************************************************
...
<div align="center">
    <h2>Hotel UQ</h2>
	<h2>List of Most Popular Rooms</h2>
</div>	
    <?php 
 ...
 //               if(isset($_POST["submit"])) {
                    ...
                    $query = "SELECT BranchName,RoomNum,COUNT(ReservationNum) 'CRN' FROM ReservationRoom GROUP BY BranchName, RoomNum ORDER BY COUNT(ReservationNum)DESC,BranchName ASC" ;
