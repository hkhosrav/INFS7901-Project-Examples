...
*** Notes **********************************************************************
This web pages provides a form for customers to send inquiries to the hotel administration.
But, connection to the actual SMTP server feature has been disabled as it is out of scope
Form process no error when all fields are filled in and form is submitted
********************************************************************************
  ...
  <div class="8u">
    <section class="left-content">
     <h2><?php echo stripslashes($pageDetails["page_title"]); ?></h2>
      ...
      <div class="success">Thank you for contacting us. We will get back to you as soon as we can.</div>
      <?php } if ($_GET["msg"] == "error") {  ?>
      <div class="error">Thank you for contacting us. We will get back to you as soon as we can.</div>
      <?php } ?>
