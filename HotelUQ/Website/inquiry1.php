...
*** Notes **********************************************************************
This file provides functionality to view a list of all rooms with including 
branch and room type 
********************************************************************************
        ...
        <tbody id="Rooms">
            <?php
               ...
               // if(isset($_POST["submit"])) {
                    ...
                    $query = "SELECT * FROM `RoomBranchType` ORDER BY `BranchName`,`RoomNum`,'Capacity' ASC" ;
